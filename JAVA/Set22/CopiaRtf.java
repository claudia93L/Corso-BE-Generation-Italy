...
public class CopiaRtf {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            File inputFile = new File("JAVA/Set22/ProvaCaratteri.rtf");
            File outputFile = new File("JAVA/Set22/CopiaDiDocumento.rtf");
            ...
            while (in.ready()) { // finché ci sono caratteri a destra della posizione corrente, ready()
