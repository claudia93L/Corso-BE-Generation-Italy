...
public class CamiciaCostruttore {
    ...
    // introduco il costruttore - deve avere lo stesso nome della classe richiamata - riceve tutti i campi che gli servono come argomenti. con il costruttore, si effettua un unico invio di dati - utilizzare il costruttore non significa automaticamente incapsulare
    public CamiciaCostruttore(int camiciaID, String descrizione, char codiceColore, double prezzo, int disponibili, int acquistate){

        setCamiciaID(camiciaID); // invoco il campo tramite incapsulamento con il metodo set()
        ...
        // tutto ciò che mi arriva tramite il costruttore, lo vado a controllare con i set()
    }

    // ricreo il costruttore predefinito, necessario se voglio istanziare una CamiciaCostruttore come fatto per Camicia.java (file di oggi)
    public CamiciaCostruttore(){}
    ...
    public int getDisponibili(){ // int perchè disponibili è un int
        return disponibili;
    }
